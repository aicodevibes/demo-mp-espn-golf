...
import { ShieldCheck, LogIn, LogOut, Trophy } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            {eventName && (
              <p className="text-xs text-emerald-400 font-medium truncate max-w-xs sm:max-w-md">
                Active Event: <span className="text-slate-300">{eventName}</span>
              </p>
            )}
          </div>
        </div>
