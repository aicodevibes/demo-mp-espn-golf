# 03 — Gold Champion Hero Card Styling & Trophy Badges

**What to build:** Update `TrackedPlayerHeroGrid.tsx` and `LiveLeaderboard.tsx` to render the gold 🏆 trophy icon next to the champion when status is Final, and apply Gold Crown Border & Gradient (`border-amber-400 bg-linear-to-b from-amber-950/60 to-slate-900`) to the winner's Hero Card.
